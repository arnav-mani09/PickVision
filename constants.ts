...
export const GEMINI_MODEL_TEXT = 'gemini-2.5-flash-preview-04-17'; // For text generation
export const GEMINI_MODEL_VISION = 'gemini-2.5-flash-preview-04-17'; // For image analysis (multimodal)
