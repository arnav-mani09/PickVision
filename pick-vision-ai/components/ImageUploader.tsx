...
export const ImageUploader: React.FC<ImageUploaderProps> = ({ 
  ...
  return (
    <Card className={isLoading ? 'opacity-70 pointer-events-none' : ''}>
      <div className="p-6">
        <h2 className="text-xl font-semibold mb-4 text-indigo-400">Upload Your Parlay Image</h2>
        
        <div 
          className={`border-2 ${dragActive ? 'border-indigo-500 bg-gray-700' : 'border-gray-600 border-dashed'} rounded-lg p-8 text-center transition-colors duration-200 ease-in-out`}
